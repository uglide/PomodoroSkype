...
namespace PomodoroSkype.dataDataSetTableAdapters {
    ...
    public partial class settingsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [main].[sqlite_default_schema].[settings] WHERE (([name] = @Original_" +
                "name) AND ([value] = @Original_value) AND ([id] = @Original_id))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [main].[sqlite_default_schema].[settings] SET [name] = @name, [value] = @v" +
                "alue WHERE (([name] = @Original_name) AND ([value] = @Original_value) AND ([id] " +
                "= @Original_id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PomodoroSkype.Properties.Settings.Default.defaultDbConnection;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT name, value, id FROM settings";
        ...
        public virtual int Fill(dataDataSet.settingsDataTable dataTable) {
        ...
        public virtual dataDataSet.settingsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dataDataSet.settingsDataTable dataTable = new dataDataSet.settingsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dataDataSet.settingsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_name, string Original_value, long Original_id) {
        ...
        public virtual int Update(string name, string value, string Original_name, string Original_value, long Original_id) {
            if ((name == null)) {
